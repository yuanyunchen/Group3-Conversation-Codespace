...
round_name="test_balanced_player_threhold_0.5__0915_${test_player}"
...
# python main.py --player $test_player 8 --player pr 2 --length $L --memory_size $B --subjects $S --output_path "$output_root/self_collaboration" --test_player $test_player $gui_flag $rounds_flag $detailed_flag
